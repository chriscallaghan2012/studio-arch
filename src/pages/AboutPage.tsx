...
import { STATS, STUDIO_COORDINATES } from '../data/mockData';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
      ...
      <div className="border-b-2 border-slate-300 pb-6">
        ...
        <p className="text-base text-slate-600 font-sans mt-3 max-w-3xl leading-relaxed">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        <div className="lg:col-span-7 relative h-80 sm:h-96 overflow-hidden border-2 border-slate-700 bg-slate-900">
          <img
          ...
          <div className="absolute bottom-4 left-4 right-4 text-white font-mono text-xs flex justify-between">
            <span>REF_01 // CRAFTSMANSHIP & RIGOR</span>
            <span>MAYFAIR STUDIO // {STUDIO_COORDINATES}</span>
          </div>
        </div>
        ...
        <div className="lg:col-span-5 space-y-4">
          <div className="grid grid-cols-2 gap-3 font-mono">
            {STATS.map((stat, idx) => (
              <div key={idx} className="p-4 bg-white border-2 border-slate-300">
                <div className="text-3xl font-extrabold text-[#001f3f] font-display">
                  {stat.value}
                </div>
          ...
          <div className="p-4 bg-[#001733] text-white border border-slate-700 font-mono text-xs space-y-2">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 font-sans">
          <div className="bg-white border-2 border-slate-300 p-6 space-y-3">
            <div className="w-10 h-10 bg-[#001f3f] text-sky-300 flex items-center justify-center font-mono font-bold text-sm">
              01
            </div>
      ...
      {/* CTA Box */}
      <div className="bg-[#001733] text-white p-8 sm:p-12 border-2 border-slate-700 flex flex-wrap items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap gap-3">
          <button
            ...
            className="px-6 py-3.5 bg-sky-500 hover:bg-sky-400 text-black font-mono text-xs font-bold uppercase tracking-wider transition-colors cursor-pointer"
          >
            DISPATCH ENQUIRY
          </button>
          <button
            onClick={onOpenEstimator}
            className="px-6 py-3.5 bg-transparent border-2 border-slate-500 hover:border-white text-white font-mono text-xs font-bold uppercase tracking-wider transition-colors cursor-pointer"
          >
            INSTANT ESTIMATOR
          </button>
        </div>
